...
<%@page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
    <% 
	String StaticUrl=URLResolver.getStaticUrl(); 
	%>
...
<html>
 <meta charset="utf-8">
  ...
  <!-- Bootstrap 3.3.6 -->
  <link rel="stylesheet" href="<%=StaticUrl %>/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<%=StaticUrl %>/adminlte/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<%=StaticUrl %>/adminlte/css/skins/_all-skins.min.css">
